...
pub const ewram: *volatile [0x20000]u16 = @ptrFromInt(mem.region.ewram);
pub const iwram: *volatile [0x2000]u32 = @ptrFromInt(mem.region.iwram);
...
const Header = extern struct {
    ...
    reserved_area: [7]u8 align(1) = @splat(0),
    software_version: u8 align(1) = 0x00,
    complement_check: u8 align(1) = 0x00,
    reserved_area_2: [2]u8 align(1) = @splat(0),
};
